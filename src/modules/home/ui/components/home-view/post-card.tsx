...
type PostCardProps = {
  data: ManyPostTypes['items'][number];
  onFocusColor?: {
    darkTheme: string;
    lightTheme: string;
  };
...
const PostCard = ({ data }: PostCardProps) => {
  const { user, title, createdAt, likeCount, likeStatus, thumbUrl } = data;

  return (
    <div className='group relative'>
      <div className='absolute inset-0 rounded-xl duration-150 group-hover:-m-3 group-hover:bg-[#ebe2dd]' />
      <div className='relative flex flex-col gap-3'>
        <div className='aspect-video overflow-hidden rounded-none duration-150 hover:rounded-none sm:rounded-xl'>
          <Thumbnail
        ...
        <div className='flex'>
          ...
          <div className='flex w-full flex-col'>
            ...
            <div className='text-muted-foreground hover:text-primary flex items-center self-start text-xs duration-150 sm:text-sm'>
